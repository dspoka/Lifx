...
// LIFXKit
#define COCOAPODS_POD_AVAILABLE_LIFXKit
#define COCOAPODS_VERSION_MAJOR_LIFXKit 0
#define COCOAPODS_VERSION_MINOR_LIFXKit 5
#define COCOAPODS_VERSION_PATCH_LIFXKit 0
